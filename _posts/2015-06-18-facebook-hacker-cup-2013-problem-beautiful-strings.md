...
There was a certain fun problem which stood out to me and the reason being was that it reminded me of a few lessons I learned in the beginning of my career, which I will be sharing them here in this post.
...
Now the first question that would naturally arise is how in the world do we calculate a beautiful string? That's a great question and pretty much the key to finding the solution.
...
I then went ahead and did this calculation `A = 1, B = 2, C = 3` (the numbers being the amount of times they have occurred). Even though it says "no two letters have the same beauty" I just assumed that it meant two different letters instead of the same letter repeating.
...
I got the answer but still couldn't answer the question as to how I would go about finding the rest of the letters since there are so many unknowns.
...
I started from the main method and wrote it all up as how I imagined it to be. Some functions still not existing, but the skeleton is complete.
...
Finally the most interesting part to me was to get the beauty of a string given an array of characters representing the sentence or single line from the given file.
...
Now some here are the lessons it taught me and reminded me of some other ones from the past.
...
> Requirements are not always going to be clear, it is your responsibility to do the best you can to clarify them for yourself.

> Making assumptions is OK as long as you verify them at the end and do your best to understand why that assumption worked so that next time faced with a similar situation you don't have to make assumptions.

That's it ladies and gentlemen. I hope it helped you in some way and reminded you of a few lessons that you have learned in the past. I would definitely recommend you solving at least one problem a day if you are serious about developing your craft.

Solving problem a day keeps complacency away. But, seriously, it's fun :) 
